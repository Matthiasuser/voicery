...
description: "Learn how to use your existing phone numbers or Twilio account with Voicery.ai through SIP integration or Caller ID verification"
---
...
- Inbound & outbound will flow through your existing lines, but still utilize Voicery.ai's AI.
...
- Meanwhile, you can have the best of both worlds by provisioning Twilio-based numbers through Voicery.ai or using a custom approach.
