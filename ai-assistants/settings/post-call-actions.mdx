...
<AccordionGroup>
  ...
  <Accordion title="Webhook URL" icon="link">
    ...
    **Example:** `https://automate.voicery.ai/api/v1/webhooks/your-webhook-id`
...
```json
{
  ...
  "transcript": [
    {
      "text": "Hello! This is Sarah from Voicery.",
      "type": "transcript",
      "sender": "bot",
  ...
  "formatted_transcript": "AI: Hello! This is Sarah from Voicery.\\nCustomer: Hi, I'm doing well, thanks.",
  "recording_url": "https://app.voicery.ai/storage/recordings/call-12345.mp4",
