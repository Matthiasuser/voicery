...
4. Click on external services and then check the option for SIP URI.
  ...
  Add ```sip:extension@5wed79aeavr.sip.livekit.cloud ``` (this is Voicery SIP server address) .
...
## Step 2: Import numbers to Voicery

You need to import to Voicery.
...
For PBX Extension:
   ...
   <Frame>
     <img
       src="/resources/zadarma-Voicery-type.png"
