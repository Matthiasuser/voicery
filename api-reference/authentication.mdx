...
The Voicery API uses API keys to authenticate requests. You need to include your API key in the header of each request you make to the API.

## Obtaining an API Key

To obtain an API key:

1. Log in to your Voicery account at [https://app.voicery.ai](https://app.voicery.ai)
...
```bash
curl -X GET "https://api.voicery.ai/api/user/campaigns" \
